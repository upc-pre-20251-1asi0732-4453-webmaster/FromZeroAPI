                    ...
                    deliverablesCommandList= Arrays.asList(
                            new CreateDeliverableCommand(
                                    ...
                                    """
                                            ...
                                            """,
                                    today.toString(), project.getId(), 1),
                            new CreateDeliverableCommand(
                                    ...
                                    """
                                            ...
                                            """,
                                    today.plusWeeks(1).toString(),project.getId(), 2),
                            new CreateDeliverableCommand(
                                    ...
                                    """
                                            ...
                                            """,
                                    today.plusWeeks(2).toString(),project.getId(), 3),
                            new CreateDeliverableCommand(
                                    ...
                                    """
                                            ...
                                            """,
                                    today.plusWeeks(3).toString(),project.getId(), 4)
                    );
                ...
                case "Aplicacion web":
                    deliverablesCommandList = Arrays.asList(
                            ...
                            new CreateDeliverableCommand(
                                    ...
                                    """,
                                    today.plusWeeks(6).toString(), project.getId(), 4)
                    );
                    this.deliverableCommandService.handle(deliverablesCommandList);
                    break;
